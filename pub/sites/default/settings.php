 ...
 */
$drupal_hash_salt = 'E3ffrAq8F48CLDcRRHylb-NHHgTN4pmsQ5a8xaEV2ng';
 ...
 * Local settings.
 */
if (file_exists(DRUPAL_ROOT . '/../etc/local-settings.inc')) {
  require DRUPAL_ROOT . '/../etc/local-settings.inc';
}
